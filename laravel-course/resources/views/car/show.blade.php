                ...
                <div class="car-images-and-description">
                    ...
                    <div class="card car-detailed-description">
                        ...
                        <ul class="car-specifications">
                            <x-car-specifation :value="$car->features->air_conditioning">
                                Air Conditioning
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->power_windows">
                               Power windows
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->power_door_locks">
                               Power door locks
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->cruise_control">
                                Cruise Control
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->bluetooth_connectivity">
                                Bluetooth Connectivity
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->remote_start">
                                Remote Start
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->gps_navigation">
                                Gps Navigation
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->heater_seats">
                                Heater seats
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->climate_control">
                                Climate control
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->rear_parking_sensors">
                                Rear parking sensors
                            </x-car-specifation>
                            <x-car-specifation :value="$car->features->leather_seats">
                                Leather seats
                            </x-car-specifation>
